...
public class Event implements Comparable<Object> {
	...
	/**
	 * A constructor for Event. Takes title, year, month, day, first hour, and first
	 * minute as parameters. Initializes the name and startTime instance variables
	 ...
	 *            first minute of event
	 */
	public Event(String title, int year, int month, int day, int startHour, int startMin) {
		name = title;
		startTime = new GregorianCalendar(year, month, day, startHour, startMin);
		if (day == 31 && month != 12) {
			x = 1;
